...
class ApplicationWindow(tk.Frame):
    def __init__(self, master):
        ...
        # Start creating all the widgets #
        ...
        # Stop creating all the widgets #

    # Function to handle the placeholder text for name entry
    ...
    # Check if entry into time boxes is numeric
